...
class newUserForm(forms.Form):
    ...
    email=form.EmailField(help_text='A valid email address, please.')
    ciudad=form.CharField(max_length=100,required=True,widget=forms.TextInput(attrs={'class': "form-control"}))
