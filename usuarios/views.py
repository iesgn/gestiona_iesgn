...
def getGrupo(lista):
    ...
    for usuario in lista:
        for gr in grupo.keys():
            lista2=ldap.gnBuscar(cadena="(cn=%s)" % gr)
            if "uid=%s,ou=People,dc=gonzalonazareno,dc=org" % usuario["uid"][0] in lista2[0]["member"]:
                usuario["description"][0]=grupo[lista2[0]["member"]]
